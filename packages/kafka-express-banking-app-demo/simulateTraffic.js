...
const baseURL = 'http://localhost:12301';
...
const staticRequests = [
  ...
  axios.get(`${baseURL}/dollar-conversion-test`, { params: {} }),
...
async function sampleFlow() {
  try {
    ...
    await axios.put(`${baseURL}/update-customerAddress`, data.updateCustomerAddress({ customerId: newCustomerId, address: onboardData.address }));
    ...
    // const fetchAccountId = await axios.get(`${baseURL}/fetch-accountId`, { params: { customerId: newCustomerId }});
